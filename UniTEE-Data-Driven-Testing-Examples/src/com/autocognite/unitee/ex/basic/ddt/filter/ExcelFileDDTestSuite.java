package com.autocognite.unitee.ex.basic.ddt.filter;
...
public class ExcelFileDDTestSuite extends DDTestSuiteForMapData{
	...
	public void init() throws Exception{
		setDataSource(this.getRunConfiguration().getStringPropValue("runner.data.directory") + "/input_exclude_option.xls");
	}
