package in.unitee.ex.assertions;
...
public class AssertionsTestMethodSuite extends TestMethodSuite{
	 ...
	 */
	public void testFailingAssertionWithMessage(){
		checker.assertTrue("Blog post should be created.", false);
	}
	...
	public void testAssertEqualsPass(){
		checker.assertEquals("Number of comments should match the expected number.", 23,23);
	}

	public void testAssertEqualsFail(){
		checker.assertEquals("Number of comments should match the expected number.", 23,19);
	}
	 ...
	 */
	public void testAssertEqualsForDoublePass(){
		checker.assertEquals("Total cost must match.", 11.25, 11.23, 0.02);
	}

	public void testAssertEqualsForDoubleFail(){
		checker.assertEquals("Total cost must match.", 11.25, 11.23, 0.01);
	}
	...
	public void testAssertSamePass(){
		...
		checker.assertSame("String builders should point to the same object.", sb1,sb2);
	}
	...
	public void testAssertNullPass(){
		...
		checker.assertNull("String builder should not be initialized.", sb);
	}
	...
	public void testAssertArrayEqualsPass(){
		int[] arr1={1,1};
		int[] arr2={1,1};
		checker.assertArrayEquals("Student scores shown in web must match DB data",arr1, arr2);
	}
	...
	public void testFail() throws Exception{
		checker.fail("Application showed wrong behavior. Reason: <XYZ>");
	}
	
	public void testError() throws Exception{
		checker.error("A test file is missing. Needs investigation. Terminating the test.");
	}
}
